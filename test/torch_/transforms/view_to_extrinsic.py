...
def run():
    for i in range(100):
        ...
        expected = utils3d.numpy.view_to_extrinsics(utils3d.numpy.view_look_at(eye, lookat, up))
        ...
        actual = utils3d.torch.view_to_extrinsics(utils3d.torch.view_look_at(eye, lookat, up)).cpu().numpy()
