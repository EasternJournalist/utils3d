...
def run():
    for i in range(100):
        ...
        expected = utils3d.numpy.perspective_to_intrinsics(
        ...
        actual = utils3d.torch.perspective_to_intrinsics(
            utils3d.torch.perspective_from_fov_xy(fov_x, fov_y, near, far)
        ).cpu().numpy()
