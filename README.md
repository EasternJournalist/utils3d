...
| `utils3d.colorize_probability_map`<br>Colorize probability map for visualization. | [`utils3d.np.colorize_probability_map(probability, cmap, alpha, beta)`](utils3d/numpy/maps.py#L812) | - | 
| `utils3d.colorize_segmentation_map`<br>Colorize segmentation map for visualization. The same value will be assigned with the same color. | [`utils3d.np.colorize_segmentation_map(segmentation, vdim)`](utils3d/numpy/maps.py#L760) | - | 
...
| `utils3d.flood_fill`<br>Flooding fill the holes in the image(s) according to the mask. ![doc/flood_fill.png](doc/flood_fill.png) | [`utils3d.np.flood_fill(image, mask, return_index)`](utils3d/numpy/maps.py#L852) | [`utils3d.pt.flood_fill(image, mask, return_index)`](utils3d/torch/maps.py#L566) | 
| `utils3d.fractal_perlin_noise_map`<br>Generate fractal Perlin noise map. ![fractal_perlin_base_frequeny2_octaves7_gain0.7.png](doc/fractal_perlin_base_frequeny2_octaves7_gain0.7.png) | [`utils3d.np.fractal_perlin_noise_map(size, base_frequency, octaves, lacunarity, gain, seed, dtype)`](utils3d/numpy/maps.py#L998) | [`utils3d.pt.fractal_perlin_noise_map(size, base_frequency, octaves, lacunarity, gain, seed, dtype, device)`](utils3d/torch/maps.py#L715) | 
...
| `utils3d.perlin_noise`<br>Generate Perlin noise for the given coordinates. | [`utils3d.np.perlin_noise(x, seed)`](utils3d/numpy/maps.py#L911) | [`utils3d.pt.perlin_noise(x, seed)`](utils3d/torch/maps.py#L626) | 
| `utils3d.perlin_noise_map`<br>Generate Perlin noise map. | [`utils3d.np.perlin_noise_map(size, frequency, seed, dtype)`](utils3d/numpy/maps.py#L976) | [`utils3d.pt.perlin_noise_map(size, frequency, seed, dtype, device)`](utils3d/torch/maps.py#L686) | 
